...
def convert_png_to_pgm_p2_2(input_png, grapyscale_png, output_pgm):
    # Abra a imagem PNG e converta para escala de cinza
    img = Image.open(input_png).convert("L")
    width, height = img.size
...
# Exemplo de uso
# convert_png_to_pgm_p2_2("teste.png", "teste_cinza.png", "teste.pgm")
...
def prompt_user_to_choose_image():
    ...
    convert_png_to_pgm_p2_2(f"./images/{images[choice]}", f"./output/result_gray.png", f"./output/original.pgm")
    convert_png_to_pgm_p2(f"./images/{images[choice]}", f"./output/original.pgm")
